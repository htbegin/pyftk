...
FtkWidget._fields_ = [
        ...
        ('priv_subclass', ctypes.c_void_p * ftk.constants.FTK_WIDGET_SUBCLASS_NR)
        ]
...
ftk_widget_update_rect = ftk.dll.function('ftk_widget_update_rect',
        '',
        args=['thiz', 'rect'],
        arg_types=[_FtkWidgetPtr, ctypes.POINTER(ftk.typedef.FtkRect)],
        return_type=ctypes.c_int)
...
_ftk_widget_set_user_data = ftk.dll.private_function(
        ...
        arg_types=[_FtkWidgetPtr, ftk.typedef.FtkDestroy, ctypes.c_void_p],
        return_type=None)
