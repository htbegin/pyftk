...
FtkFont._fields_ = [
        ...
        ('ref', ctypes.c_int),
        ('font_desc', ctypes.POINTER(ftk_font_desc.FtkFontDesc)),
...
ftk_font_get_desc = ftk_dll.function('ftk_font_get_desc',
        ...
        return_type=ctypes.POINTER(ftk_font_desc.FtkFontDesc),
        dereference_return=True)
...
ftk_font_create = ftk_dll.function('ftk_font_create',
        ...
        arg_types=[ctypes.c_char_p, ctypes.POINTER(ftk_font_desc.FtkFontDesc)],
        return_type=_FtkFontPtr,
        dereference_return=True,
        require_return=True)
